...
- [opencode zen](https://opencode.ai/docs/zen/) (ling-3.0-flash-free) for implementing [#3](https://github.com/genidma/darya-genie/issues/3): satellite imagery detection pipeline — AerialWaste riverine data ingestion, YOLOv8/Mask R-CNN training workflows, spectral analysis (NDVI/NDWI/AWI/NDBI), and enhanced tiling infrastructure.
